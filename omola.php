...
?>
  ...
  <form method="post" action="omola.php">
  <table id="header">
  <tr>
  ...
  <td style="width:80px;">
   <a href="badlahType.php" style="width:80px;">+إضافة</a>
  ...
  $count=1;
  while ($row = mysqli_fetch_array($result)){
  echo '<form method="POST" action="omola.php">';
  ...
  echo "<td style='width:50px;'>";
      echo "<input style='width:80px; margin-left:0px;margin-right:2px;color:red;text-align:center;' name='badlah_id' value='" .  $row['badlah_id'] . "'".' readonly></input>';
      echo "</td>";   
      echo "<td>";
...
setTimeout(function(){
  ...
  <script src="doMathMultiplyOmola.js">
<script>
