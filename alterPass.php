...
<tr>
<td>
  كلمة المرور الجديدة: <input type="text" style="width:180px;" name="newPass" value="<?php if(isset($_POST['newPass'])){ echo htmlentities($_POST['newPass']);}?>" class="fullname required_field">
  </td>
  <td>
...
<hr>
<h3 style="align:center">تعديل كلمة المرور</h3>
<div style='width: 100%; padding 10px; margin: auto; text-align: center;'>
