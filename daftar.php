...
// To protect MySQL injection (more detail about MySQL injection)
			...
			{
				//currentDateAndTime, dateOfToday) VALUES ('".$senf."', '".$se3r."', '".$currentDateTime."', '".$currentDate."')";
   ...
   exit();
		...
		$updateQuery="UPDATE daftarM  SET se3r= '" . $se3r . "', senf='".$senf."', se3rS='".$se3rS."', senfS='".$senfS."', si3rM='".$si3rM."', naw3M='".$naw3M."' WHERE daftar_id='" . $_POST['hidden']."'";
