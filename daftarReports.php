...
?>
<form action="daftarReports.php" method="post">
<table>
<tr>
<td>
<fieldset>
...
onClick="document.location.href='mainPage.php'" ></input>
...
function printVal1($conn, $sql){
	...
	echo '<table style="width:450px;table-layout:auto;border-radius:1px;border-color:black;">';
...
echo '<td>';
	...
	echo '</tr>';
	echo '</table>';
	echo '<table style="width:730px;align:center;margin-left:380px;">';
	echo '<tr>';
	echo '<td>';
	echo '<input type="hidden" value="hidden"></input>';
	echo '</td>';
	...
	echo '</tr>';
	echo '</table>';
echo '<table style="width:1300px;align:center;margin-left:25px;">';
	echo '<tr class="border_bottom">';
	echo '<th style="width:40px;max-width:200px;">الرقم</th><th style="width:70px;max-width:180px;">رقم الفاتورة</th><th style="width:113px;">الصنف</th><th style="width:115px;">السعر</th><th style="width:115px;">الصنف</th><th style="width:119px;">السعر</th><th style="width:109px;">النوع</th><th style="width:100px;">السعر</th><th >مبيعات اليوم</th><th style="width:90px;"> الباقي</th><th>تاريخ البيع</th><th style="width:100px;visibility:hidden;" ></th><th style="width:43px;visibility:hidden;"></th>';
	echo '</tr>';
	echo '</table>';
echo '</div>';
$count=1;
...
$mabe3TodayTotal=0;
	...
	echo '<div align="center">';
	echo "<form action='daftarReports.php' method='POST'>";
	echo '<table style="width:1300px;table-layout:auto;">';
...
echo '</form>';
	...
	echo '<table style="width:1010px;table-layout:auto;margin-left:283px;">';
...
echo '<input type=text name=clientname style="width:100px;  border: 2px solid red; border-radius: 1px; margin-right:50px;" value="'.$mabe3CashTotal.'"></input>';
echo '</td>';
...
echo '<input type=text name=clientname style="width:100px;  border: 2px solid red; border-radius: 1px;" value="'.$sarafaTotal.'"></input>';
...
echo '<td>';
echo '<input type=text name=clientname style="width:100px; border: 2px solid red; border-radius: 1px;" value="'.$masrofatTotal.'"></input>';
...
echo '<input type=text name=clientname style="width:100px; margin-right:9px; border: 2px solid red; border-radius: 1px;" value="'.$mabe3TodayTotal.'"></input>';
...
echo '<td>';
	...
	echo '</tr>';
		echo '</table>';
	echo '<table style="width:1300px;align:center;margin-left:35px;">';
	echo '<tr class="border_bottom">';
	echo '<th style="width:40px;max-width:200px;">الرقم</th><th style="width:70px;max-width:180px;">رقم الفاتورة</th><th style="width:113px;">الصنف</th><th style="width:115px;">السعر</th><th style="width:115px;">الصنف</th><th style="width:119px;">السعر</th><th style="width:109px;">النوع</th><th style="width:100px;">السعر</th><th >مبيعات اليوم</th><th style="width:90px;"> الباقي</th><th>تاريخ البيع</th><th style="width:100px;visibility:hidden;" ></th><th style="width:43px;visibility:hidden;"></th>';
	echo '</tr>';
	echo '</table>';
...
$counter=0;
	...
	echo '<div align="center">';
	echo '<form method="post" action="daftarReports.php">';
	echo '<table style="width:1300px;table-layout:auto;">';
...
echo "<td>";
echo '<strong style="width:108px;display:inline-block;"></strong>';
echo "</td>";
