...
$result = mysqli_query($conn, $sql);
$counter=0;
echo "<table style='margin-top:20px;width:1345px'>";
echo "<tr>"; 
echo "<th style='width:28px'>الرقم</th><th style='width:80px'>رقم الفاتورة</th><th style='width:115px'>إسم الزبون</th><th style='width:145px'>رقم الهاتف</th><th style='width:135px'>نوع التصليح</th><th style='width:130px'>الكمية</th><th style='width:85px'>السعر</th><th style='width:185px'>واصل منه</th> <th style='width:105px'> الباقي</th>    <th style='width:185px'>إسم العامل</th><th style='width:145px'>تاريخ التسليم</th><th style='background-color:#F0FFF0'></th><th style='background-color:#F0FFF0'></th><th style='width:147px;background-color:#F0FFF0'></th></tr>";
$countTasleh=1;
while ($row = mysqli_fetch_array($result)) {
echo '<form method="post" action="tasleh.php">';
echo "<table style='margin-top:2px;margin-right:5px;width:1355px'>";
echo "<tr>";
...
echo "<td style='width:140px;'>";
    echo "<input type='hidden' style='width:35px' name=taslehID value='" . $row['taslehID'] . "' readonly></input>";
    ...
    echo "<td>";
      ...
      echo "<td>";
        ...
        echo "<td>";
        echo '<input style="width:110px" name=wasl id=wasl  onkeyup="doPriceSub('.$counter.')" class="wasl" value="' . $row['wasl'] . '"></input>';
        echo "</td>";
        
        
        echo "<td>";
        echo '<input style="width:110px" id="baki" name=baki value="'.$row['baki'].'" class="baki" readonly></input>';
        echo "</td>";
