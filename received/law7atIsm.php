...
<h2>البلد العملاق للخياطة العسكرية</h2>
...
<form method="post" id="jsform" action="law7atIsm.php"  style="display: inline-block"> 
<div class="clr">
<div class="style0">
  الإسم: <input type="text" name="name" value="<?php echo (isset($name)? $name:"");?>" class="fullname required_field">
</div>
  <div class="style1">  
...
<td>
  ...
  الباقي: <input type="text" name="baki" id="baki" style="width:140px" value="<?php echo $baki; ?>">
...
<td>
<input type="text" id="datepicker" name="datepicker" style="width:190px" value="<?php echo $datepicker;?>"></input>
