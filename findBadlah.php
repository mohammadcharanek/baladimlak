...
echo '    <label for="lname"><h2 style="color:rgb(139, 0, 70)">الكمية</h2></label>';
echo '	</td>';
...
echo '    <label for="lname"><h2 style="color:rgb(139, 0, 70)">السعر</h2></label>';
echo '	</td>';
...
echo '	<select name="myselectbox"   style="text-align: center; text-align-last: center;" value="'.$row['omla'].'" selected>';
...
echo '	</td>';
echo '	<td align="left" style="background-color:yellow; padding-left: 20px; padding-top: 7px;">';
echo '    <label for="lname"><h2 style="color:rgb(139, 0, 70)">المبلغ الإجمالي</h2></label>';
echo '	</td>';
...
echo '	<td align="left" style="background-color:rgb(0, 255, 202); padding-left: 7px; padding-top: 7px;">';
echo '    <label for="wasl"><h2 style="color:rgb(139, 0, 70)">الواصل</h2></label>';
echo '	</td>';
echo '	<td style="background-color:rgb(0, 255, 202)">';
...
echo '	<td align="left" style="background-color:rgb(0, 255, 202); padding-left: 20px; padding-top: 7px;">';
echo '<label for="wasl"><h2 style="color:rgb(139, 0, 70)">الباقي </h2></label>';
